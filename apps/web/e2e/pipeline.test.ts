...
test.describe('Pipeline Kanban Board', () => {
  test('unauthenticated users are redirected from pipeline to login', async ({ page }) => {
    test.skip(process.env.AUTH_BYPASS === 'true', 'AUTH_BYPASS skips redirect')
    await page.goto('/pipeline')
    await expect(page).toHaveURL(/\/login/)
  })

  test('pipeline page renders with heading', async ({ page }) => {
  ...
  test('empty stages show "Empty" placeholder text', async ({ page }) => {
  ...
  test('lead cards display in their assigned stages', async ({ page }) => {
  ...
  test('opportunity cards display in their assigned stages', async ({ page }) => {
  ...
  test('stage droppable areas have accessible labels', async ({ page }) => {
  ...
  test('drag and drop moves a lead card between stages', async ({ page }) => {
